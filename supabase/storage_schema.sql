...
CREATE POLICY "Public read user avatars" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'user-avatars'::"text"));



CREATE POLICY "Users can delete their avatar" ON "storage"."objects" FOR DELETE USING ((("bucket_id" = 'user-avatars'::"text") AND ("auth"."uid"() = "owner")));



CREATE POLICY "Users can update their avatar" ON "storage"."objects" FOR UPDATE USING ((("bucket_id" = 'user-avatars'::"text") AND ("auth"."uid"() = "owner")));



CREATE POLICY "Users can upload their avatar" ON "storage"."objects" FOR INSERT WITH CHECK ((("bucket_id" = 'user-avatars'::"text") AND ("auth"."uid"() = "owner")));
